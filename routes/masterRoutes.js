...
router.post("/Auth/employeeLogin", LoginController.verifyLogin);

router.post("/Auth/clientLogin", LoginController.verifyClientLogin);
...
router.post(
  ...
  EmployeeController.employeeUploadMiddleware,
...
router.post(
  "/WorkLocation/deleteWorkLocation",
...
router.post(
  "/WorkLocation/getAllWorkLocation",
...
router.post(
  "/Lead/getLeadsFromIndiaMart",
  LeadController.getLeadsFromIndiaMart,
);
router.post(
  "/Lead/getLeadsFromGoogleSheet",
  LeadController.getLeadsFromGoogleSheet,
);
...
router.post(
  ...
  ProjectStatusController.getAllProjectStatus,
);
...
router.post(
  ...
  TaskStatusController.getAllTaskStatus,
);
...
router.post(
  "/TaskPriority/getAllTaskPriority",
  TaskPriorityController.getAllTaskPriority,
);

//LeaveStatus Routes
router.post(
  "/LeaveStatus/createLeaveStatus",
  LeaveStatusController.createRequestStatus,
);
router.post(
  "/LeaveStatus/deleteLeaveStatus",
  LeaveStatusController.deleteRequestStatus,
);
router.post(
  "/LeaveStatus/updateLeaveStatus",
  LeaveStatusController.updateRequestStatus,
);
router.post(
  "/LeaveStatus/getAllLeaveStatus",
  LeaveStatusController.getAllRequestStatus,
);
...
router.post(
  ...
  PermissionController.deletePermissionRequest,
);
router.post(
  "/Permission/updatePermission",
  PermissionController.updatePermissionRequest,
);
router.post(
  "/Permission/getAllPermissions",
  PermissionController.getAllPermissionRequests,
);
router.post(
...
router.post(
  "/Attendance/getAllAttendanceByDate",
...
router.post(
  "/Attendance/searchEmployeesWithAttendance",
  AttendanceController.searchEmployeesWithAttendance,
);
router.post(
